...
export const translations = {
  de: {
    ...
    noSignal: "Keine Verbindung – bitte später erneut versuchen.",
    staleData: "Veraltete Daten · zuletzt aktualisiert {t}",
    liveData: "Live · zuletzt aktualisiert {t}",
    upstreamError: "Datenquelle nicht erreichbar.",
    rateLimited: "Zu viele Anfragen – Aktualisierung verlangsamt.",
    invalidStation: "Haltestelle konnte nicht geladen werden.",
    cancelled: "fällt aus",
  ...
  en: {
    ...
    noSignal: "No connection – please try again later.",
    staleData: "Stale data · last updated {t}",
    liveData: "Live · last updated {t}",
    upstreamError: "Data source unavailable.",
    rateLimited: "Too many requests – refresh slowed down.",
    invalidStation: "Station could not be loaded.",
    cancelled: "cancelled",
